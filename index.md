...
<div class="container mt-5 mb-5">
    ...
    <div class="row mt-5">
        <div class="col-md-4">
            ...
            <p>Use the same query languge to define <i>what</i> to compute and <i>when</i> to compute it.</p>
        </div>
    ...
    <div class="row">
        <div class="col-6">
            ...
            <a class="btn btn-primary" href="https://kaskada-ai.github.io/docs-site/kaskada/main/getting-started/hello-world.html">Get Started</a>
        </div>
        <div class="col-6">
